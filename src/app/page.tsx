    ...
    <div className={`min-h-screen pt-16 ${
      ...
      <main className="p-4">
        <div className="max-w-md mx-auto">
          <h2 className={`text-2xl font-bold mb-4 text-center ${isDarkMode ? 'text-blue-200' : 'text-blue-900'}`}>저축 목표</h2>
          <div className="flex justify-center mb-4">
            <div className={`inline-block px-4 py-2 rounded-xl border-2 ${
              isDarkMode ? 'bg-blue-950 border-blue-800 text-blue-100' : 'bg-blue-200 border-blue-400 text-blue-900'
            }`}>
          ...
          <div className={`p-6 rounded-xl shadow-lg border ${
            isDarkMode ? 'bg-gray-800 border-blue-950' : 'bg-white border-blue-200'
          } mb-6`}>
            <h3 className={`text-xl font-semibold mb-4 ${isDarkMode ? 'text-blue-200' : 'text-blue-900'}`}>목표 품목 설정</h3>
          ...
          <div className={`p-6 rounded-xl shadow-lg border ${
            ...
            <div className="flex justify-between items-center mb-4">
              <h3 className={`text-xl font-semibold ${isDarkMode ? 'text-blue-200' : 'text-blue-900'}`}>현재 목표</h3>
            </div>
            <div className="flex items-center gap-6">
              <div className={`w-32 h-32 flex items-center justify-center rounded-lg ${
                isDarkMode ? 'bg-blue-950' : 'bg-blue-100'
              }`}>
                <GiftIcon className={`w-16 h-16 ${isDarkMode ? 'text-blue-300' : 'text-blue-700'}`} />
              </div>
              <div className="flex-1">
                <h4 className={`text-lg font-semibold ${isDarkMode ? 'text-blue-100' : 'text-blue-900'}`}>{goalItem.name}</h4>
          ...
          <div className={`p-6 rounded-xl shadow-lg border ${
            ...
            <div className="flex justify-between items-center mb-4">
              <h3 className={`text-xl font-semibold ${isDarkMode ? 'text-blue-200' : 'text-blue-900'}`}>저축 현황</h3>
              <p className={`text-2xl font-bold ${isDarkMode ? 'text-blue-200' : 'text-blue-700'}`}>
                500,000원
              </p>
            </div>
